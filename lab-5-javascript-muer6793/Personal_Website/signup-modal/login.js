function openModal() {
  ...
  myInput.onkeyup = function () {
    ...
    var lowerCaseLetters = /dummy_regex/g; // : Fill in the regular expression for lowerCaseLetters
    var upperCaseLetters = /dummy_regex/g; // : Fill in the regular expression for upperCaseLetters
    var numbers = /dummy_regex/g; // Fill in the regular expression for digits
    var symbols = /dummy_regex/g; // Fill in the regular expression for symbols
